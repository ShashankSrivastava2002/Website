 ...
 *
 * The sections below are presentational — they take this and lay it out. That
 * split is why the copy survived a rewrite that deleted every component around
 * it: content that lives in components dies with them.
 */
